...
/* 0x00 - 0x03*/	add_rb2rb, add_rv2rv, add_rb2rb_r, add_rv2rv_r,
/* 0x04 - 0x07*/	inv, add_iv2eax, inv, inv,
/* 0x08 - 0x0b*/	or_r2r_b, or_r2r_v, or_r2r_b_r, or_r2r_v_r,
/* 0x0c - 0x0f*/	inv, inv, inv, opcode_2_byte,
/* 0x10 - 0x13*/	inv, adc_rm2rm_v, inv, inv,
/* 0x14 - 0x17*/	inv, inv, inv, inv,
/* 0x18 - 0x1b*/	inv, inv, inv, inv,
/* 0x1c - 0x1f*/	inv, inv, inv, inv,
/* 0x20 - 0x23*/	and_r2r_b, and_r2r_v, and_r2r_b_r, and_r2r_v_r,
/* 0x24 - 0x27*/	inv, inv, inv, inv,
/* 0x28 - 0x2b*/	sub_r2r_b, sub_r2r_v, sub_r2r_b_r, sub_r2r_v_r,
/* 0x2c - 0x2f*/	inv, inv, inv, inv,
/* 0x30 - 0x33*/	xor_r2r_b, xor_r2r_v, xor_r2r_b_r, xor_r2r_v_r,
/* 0x34 - 0x37*/	inv, inv, inv, inv,
/* 0x38 - 0x3b*/	cmp_rb2rb, cmp_rv2rv, cmp_rb2rb_r, cmp_rv2rv_r,
/* 0x3c - 0x3f*/	inv, inv, inv, inv,
/* 0x40 - 0x43*/	inc_eax, inc_ecx, inc_edx, inc_ebx,
/* 0x44 - 0x47*/	inc_esp, inc_ebp, inc_esi, inc_edi,
/* 0x48 - 0x4b*/	dec_eax, dec_ecx, dec_edx, dec_ebx,
/* 0x4c - 0x4f*/	dec_esp, dec_ebp, dec_esi, dec_edi,
...
/* 0x74 - 0x77*/	je, jne, jbe, inv,
/* 0x78 - 0x7b*/	inv, inv, inv, inv,
/* 0x7c - 0x7f*/	inv, inv, jle, jg,
...
/* 0xe8 - 0xeb*/	call_Av, jmp_near, inv, jmp_short,
...
{add_i2v, inv, inv, inv, inv, inv, inv, cmp_i2v_l};

/* 0x83 */
instr_func group_1_bv_entry[8] =
{add_i82v, inv, inv, inv, and_si2r_v, sub_i2rm_v, inv, cmp_i2r_v};
/* 0xc0 */
...
{inc_ev, inv, inv, inv, inv, inv, push_v, inv};
